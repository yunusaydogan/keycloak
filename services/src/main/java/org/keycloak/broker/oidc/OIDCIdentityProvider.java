...
public class OIDCIdentityProvider extends AbstractOAuth2IdentityProvider<OIDCIdentityProviderConfig> implements ExchangeExternalToken {
    ...
    protected BrokeredIdentityContext getFederatedIdentityEdevlet(String accessToken) {
        ...
        try {
            BrokeredIdentityContext identity = extractIdentityFromProfileEdevlet(null,doHttpGetUserInfoWithTc(accessToken, getConfig().getClientId()));
    ...
    protected JsonNode doHttpGetUserInfoWithTc(String AccessToken, String clientid ) throws IOException {
    ...
    //bidb edevlet için gerekli func. gerekli oAuth2 işlemleri yapılıyor ==bitiş==
